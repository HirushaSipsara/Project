...
int main() {
    ...
    // Now, add the upper section (including bonus if applicable) to the total
    human_total = human_temp;
    computer_total = computer_temp;
        for (int i = 0; i < NUM_ROUNDS; i++) {
            if(i == 6){
                if(human_total > 60){
                    human_total+=60;
                }else if(computer_total > 60){
                    computer_total+=60;
                }
            }
